cd ./src
docker build -t order-api:latest -f ./Services/Order/Order.API/Order.API.Dockerfile . --build-arg DOTNET_ENVIRONMENT="PRODUCTION" --build-arg RMQ_HOST="dl-rabbitmq"
